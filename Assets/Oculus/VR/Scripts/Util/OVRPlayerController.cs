...
public class OVRPlayerController : MonoBehaviour
{
	...
	// public Scene kitchenScene;
	void Start()
	{
		pos = new Vector3(0,0,0);
		timeOfLastFrame = Time.fixedTime;
		// block.transform.transform.position =  new Vector3(0, 0, 0);
	...
	void Update()
	{
		...
		// if(Time.fixedTime - timeOfLastFrame > 2){
		// 	pos = pos + new Vector3(0,0,5);
		// 	player.transform.position = pos;
		// 	Debug.Log("adsf");
		// 	timeOfLastFrame = Time.fixedTime;
		...
		if(OVRInput.Get(OVRInput.Button.PrimaryTouchpad)){
			...
			// block.transform.transform.position =  new Vector3(5, 0, 0);
			// Vector3 pos = new Vector3(0, 0, 0);
			// block.transform.transform.position = pos;
			// Vector3 pos = new Vector3(-2, 1, 5);
			// Debug.Log(block.transform.transform.position);
			// block.transform.transform.position += pos;
